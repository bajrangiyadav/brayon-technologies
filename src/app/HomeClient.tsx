  ...
  return (
    <div className="min-h-screen bg-[#070B19] text-slate-100 selection:bg-blue-600 selection:text-white overflow-x-hidden flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section id="process" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 scroll-mt-20">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="text-blue-400 text-xs font-bold uppercase tracking-widest mb-2 font-mono">
        ...
        <section id="founder" className="py-24 bg-[#050814] border-y border-slate-800/80 scroll-mt-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* PRICING & PACKAGES */}
        <section id="pricing" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 scroll-mt-20">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="text-blue-400 text-xs font-bold uppercase tracking-widest mb-2 font-mono">
        ...
        {/* FREQUENTLY ASKED QUESTIONS */}
        <section id="faq" className="py-24 bg-[#050814] border-t border-slate-800/80 scroll-mt-20">
        ...
        <section id="contact" className="py-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 scroll-mt-20">
